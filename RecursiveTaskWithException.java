...
public class RecursiveTaskWithException {
	...
	public static class PickFruitTask extends RecursiveTask<Integer> {
		...
		protected Integer compute() {
			...
			// cancel() method is designed to be invoked by other tasks. 
			// To terminate the current task, you can just return or throw an unchecked exception from its computation method, or invoke completeExceptionally(Throwable).
