...
public class RecursiveTaskDemo {
	...
	public static void main(String[] args) {
		...
		// Performs the given ForkJoinTask, returning its result upon completion.
	...
	public static class PickFruitTask extends RecursiveTask<Integer> {
		...
		protected Integer compute() {
			...
			rightSum.fork(); // fork - computed asynchronously

			return leftSum.compute()// compute - computed synchronously: immediately and in the current thread
					+ rightSum.join(); // Current/main thread will wait till rightSum is complete
		}
