...
public class CallableVsRunnableWithFuture {
	...
	public static void demoFutureWithCallable() throws InterruptedException, ExecutionException {
		...
		// Try this: pizzaPickupOrder.cancel(true); // cancels the task. In case of cancellation, remove get() call, otherwise it will throw CancellationException
		...
		// get() method waits for a task to complete if required
